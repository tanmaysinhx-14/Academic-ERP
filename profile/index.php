...
<?php if(checkForEquality(checkLoginStatus($db1), true, 'strict')): // User is logged in ?>
  <?php if(checkForEquality(getUserRoleUsingUsercode($_SESSION['usercode']), 'student', 'strict')): // Student Profile is being accessed ?>
    ...
    <?php elseif(checkForEquality($userRecord['student_has_updated_username'], 1, 'strict')): // Student Username was updated before ?>
      <section class="section-border border-primary min-vh-100 ff-inter">  
        <!-- FOR SMALL SCREENS -->  
