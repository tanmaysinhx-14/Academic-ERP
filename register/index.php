...
<?php if (checkForEquality(checkLoginStatus($db1), false, 'strict')): // User is logged out ?>
  <section class="section-border border-primary ff-inter">
    <div class="container d-flex flex-column min-vh-100 justify-content-center py-10">
...
<?php elseif (checkForEquality(checkLoginStatus($db1), true, 'strict')): // User is logged in ?>
  <!-- ACCESS DENIED: USER LOGGED IN -->
